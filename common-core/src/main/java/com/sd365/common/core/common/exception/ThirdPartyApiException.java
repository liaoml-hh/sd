 ...
 * @since
 */
public class ThirdPartyApiException extends AppException {
    private static final long serialVersionUID = 6304058622501786159L;

    public ThirdPartyApiException() {
    }

    public ThirdPartyApiException(String code, String message) {
        super(code, message);
    }

    public ThirdPartyApiException(String code, String message, Throwable cause) {
        super(code, message, cause);
    }

    public ThirdPartyApiException(IErrorCode errorCode, Throwable cause) {
        super(errorCode, cause);
    }

    public ThirdPartyApiException(IModuleCode moduleCode, IErrorCode errorCode, Throwable cause) {
