 ...
 * @since
 */
public enum CommonBusinessErrorCode implements IErrorCode  {
    ...
    CommonBusinessErrorCode(int code, String message) {
        this.code = code;
    ...
    public static String msg(int code) {
        for (CommonBusinessErrorCode errorCode : CommonBusinessErrorCode.values()) {
